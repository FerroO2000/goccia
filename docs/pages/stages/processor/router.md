...
| Metric | Description |
| --- | --- |
| `total_routed_messages` | Total number of messages successfully routed. |
| `routed_messages_per_route` | Per-route routed message count, with `route_id` and `route_name` attributes. |
