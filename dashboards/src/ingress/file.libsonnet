...
l.row(
  ...
  [
    p.stat.base('Readers Total', prometheus.counter('readers', stageKind, stageName)),
    p.stat.base('Active Readers', prometheus.counter('active_readers', stageKind, stageName)),
